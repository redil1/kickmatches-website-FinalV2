...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        title: `${leagueName} Results & Scores ${year} | KickAI Matches`,
        description: `Latest ${leagueName} results, scores, and match highlights. Watch replays and goals from recent matches.`,
        alternates: {
            canonical: `/leagues/${slug}/results`
        },
        openGraph: {
            title: `${leagueName} Results & Scores ${year}`,
            description: `Latest ${leagueName} results and match highlights.`,
            url: `/leagues/${slug}/results`,
        }
    }
}
        ...
        <main className="max-w-7xl mx-auto px-4 py-10 space-y-8">
            ...
            <div className="border-b border-white/10 pb-6">
                ...
                <p className="text-gray-400">
                    Latest scores and match results for {leagueName}.
                </p>
            </div>
            ...
            <div className="space-y-4">
                {results.length > 0 ? (
                    ...
                    <div className="text-center py-12 bg-black/20 rounded-xl border border-white/5">
                        <p className="text-gray-400">No recent results found for {leagueName}.</p>
                    </div>
                )}
            </div>
            ...
            <div className="mt-12 bg-gradient-to-r from-gold-500/10 to-red-600/10 rounded-2xl p-8 text-center border border-white/10">
                <h2 className="text-2xl font-bold text-white mb-4">Watch {leagueName} Replays</h2>
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                    Missed the game? Watch full match replays and highlights with premium access.
                </p>
                <Link
